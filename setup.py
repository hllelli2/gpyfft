...
if "Windows" in platform.system():
    ...
    package_data.update(
        {"gpyfft": ["clFFT.dll", "StatTimer.dll"]},
    )
...
setup_requires = ["numpy", "cython"]  # removed numpy and cython
